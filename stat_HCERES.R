...
# Pour déterminer quels auteurs sont rattachés à ETBX, on se base sur le champs 'AFFILIATION', qui demande quelques remaniements (car AUTHORS est sous forme de liste et AFFILIATION sous forme de string séparé par des ;)
